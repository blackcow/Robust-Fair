...
class Cifar10():
    def __init__(self, mode="train"):
        ...
        if self.mode == 'train' or self.mode == 'valid':
            ...
            self.cifar10 = datasets.CIFAR10('./data', train=True, download=False)
            ...
            if self.mode == 'train':
                for c in classes:
                    ...
                    img = data_source[tmp_idx[0:4500]]
                    self.data.append(img)
                    cl = label_source[tmp_idx[0:4500]]
                ...
                for c in classes:
                    tmp_idx = np.where(label_source == c)[0]
                    img = data_source[tmp_idx[4500:5000]]
                    self.data.append(img)
                    cl = label_source[tmp_idx[4500:5000]]
                    self.labels.append(cl)
